...
import ResumeOrderForm from '@/components/edit-form/resume-order-form/resume-order-form';
...
export const ResumeFormSections = [ResumeInfoForm, ResumeOrderForm, PersonalInfoForm, WorkExperienceForm, ProjectForm, EducationForm, SkillsForm];
