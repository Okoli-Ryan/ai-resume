		...
		<div className="min-h-screen flex">
			<div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 p-12 flex-col justify-between">
				...
				<div className="space-y-6">
					<h1 className="text-4xl font-bold text-white leading-tight">Welcome back to your professional journey</h1>
					<p className="text-lg text-blue-100">Sign in to continue building your perfect resume and land your dream job.</p>
				</div>
				<div className="flex items-center gap-4">
					...
					<p className="text-sm text-blue-100">Join 10,000+ professionals building their careers</p>
				</div>
			</div>
			...
			<div className="w-full lg:w-1/2 flex items-center justify-center p-8">
				<div className="w-full max-w-md space-y-8">
					...
					<p className="text-center text-sm text-gray-500">
						...
						<Link href={Routes.signUp} className="font-semibold text-blue-600 hover:text-blue-700">
							Create one now
						</Link>
					</p>
