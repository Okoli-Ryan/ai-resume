...
import { UpdateResumeInfoSchema } from '@/services/resume/update-resume-info';
import { updateResumeOrder } from '@/services/resume/update-resume-order';
import { TResume } from '@/types/resume';

export async function updateResumeOrderAction(payload: Partial<TResume>, resumeId: string) {
    ...
    const response = await updateResumeOrder(payload, resumeId);
